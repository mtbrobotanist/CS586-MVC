...
namespace CS586MVC.Services
{
    ...
    {
        Task<ApartmentComplex> InsertApartmentComplex(ApartmentComplex apartmentComplex);
        ...
        Task<ApartmentComplexUnit> InsertApartmentComplexUnit(ApartmentComplexUnit acu);
        ...
        Task<Lease> InsertLease(Lease lease);
