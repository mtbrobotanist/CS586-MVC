    ...
    public static class DbInitializer
    {
        public static void Initialize(PropertyMismanagementContext context)
        {
            ...
            var units = new Unit[]
            {
                ...
                new Unit{BedRooms = 0, Bathrooms = 0, SquareFootage = 200},
                new Unit{BedRooms = 0, Bathrooms = 1, SquareFootage = 230},
                new Unit{BedRooms = 1, Bathrooms = 1, SquareFootage = 350},
                new Unit{BedRooms = 2, Bathrooms = 0, SquareFootage = 400},
                new Unit{BedRooms = 2, Bathrooms = 2, SquareFootage = 600},
                new Unit{BedRooms = 3, Bathrooms = 2, SquareFootage = 900}
            };
            ...
            var leases = new Lease[]
            {
                ...
                new Lease {PersonId = 2, ComplexUnitId = 2, StartDate=DateTime.Now, DurationMonths = 12, RentMonthly = 1000},
                new Lease {PersonId = 3, ComplexUnitId = 3, StartDate=DateTime.Now, DurationMonths = 12, RentMonthly = 1000},
                new Lease {PersonId = 4, ComplexUnitId = 7, StartDate=DateTime.Now, DurationMonths = 12, RentMonthly = 1000},
                new Lease {PersonId = 5, ComplexUnitId = 8, StartDate=DateTime.Now, DurationMonths = 12, RentMonthly = 1000},
                new Lease {PersonId = 6, ComplexUnitId = 9, StartDate=DateTime.Now, DurationMonths = 12, RentMonthly = 1000}
